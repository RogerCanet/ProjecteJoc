...
public class CloneWeapon : MonoBehaviour
{
    ...
    [SerializeField]private float burstWaitTime = 0f;
    [SerializeField]private int burstMax = 0;
    ...
    void Update()
    {
        ...
        if(burstCount< burstMax && burstTimer>burstWaitTime)
        {
